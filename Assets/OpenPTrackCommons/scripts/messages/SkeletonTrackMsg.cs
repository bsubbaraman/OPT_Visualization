...
namespace OpenPTrack
{
    ...
    ///
    public class SkeletonTrackMsg : RosSharp.RosBridgeClient.Message
	{
		[JsonIgnore]
		public const string RosMessageName = "opt_msgs/SkeletonTrack";
		...
		public ColorRGBAMsg color;

		public byte visibility;

		public BoundingBox2DMsg box_2D;

		public Track3DMsg[] joints;
